  ...
  # Check: https://github.com/kmonad/kmonad/blob/master/doc/faq.md#q-how-do-i-get-uinput-permissions
{
  ...
  flake.modules.homeManager.feature-kmonad-miryoku = { config, pkgs, ... }:
  let
    ...
    home.file.miryoku_lite = {
      ...
      text = ''
        ...
        (defsrc
          ...
          a s d f g h j k l ;
          z x c v b n m , . /
            lalt spc tab ralt cmp del ;; source of x220
            ;;lalt spc tab ralt sys del ;; source of t480
            ;;esc spc tab ent bspc del ;; <-- miryoku out
          '
        )
        (deflayer U_BASE
        q	w	e	r	t	z	u	i	o	p
