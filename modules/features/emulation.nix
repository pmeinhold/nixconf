{ ... }:
{
  flake.modules.homeManager.feature-emulation = { lib, pkgs, ... }:
  {
    programs.retroarch = {
      ...
      settings = {
        video_driver = lib.mkDefault "vulkan"; # vulkan, glcore, gl, gl1, sdl
        joypad_autoconfig_dir = "~/.config/retroarch/autoconfig/";
        user_language = "0"; # english
        video_fullscreen = "true";
        fps_show = "true";
        framecount_show = "false";
      # THEME
        menu_driver = "xmb";
        xmb_menu_color_theme = "2"; # Midnight Blue
        xmb_theme = "0"; # Icons
      # INPUT
      ...
      # All input binds have corresponding binds for keyboard (none), joykeys (_btn) and joyaxes (_axis) as well.
        ...
        input_player1_b = "enter"; # a and b are swapped
        input_player1_a = "escape";
        # input_player1_y = "del";
        # input_player1_x = "del";
    ...
    # video_driver = "${if hostname == "deck" then "vulkan" else "gl"}"
...
# assets_directory = "/nix/store/sx94y8rdya9b0mcm76s9s2vc9mgiz52g-retroarch-assets-1.22.0-unstable-2025-11-10/share/retroarch/assets"
...
# input_turbo_fire_toggle = "nul"
# input_turbo_fire_toggle_axis = "nul"
# input_turbo_fire_toggle_btn = "nul"
# input_turbo_fire_toggle_mbtn = "nul"
# input_turbo_mode = "0"
...
# joypad_autoconfig_dir = "/nix/store/1bzrbfpqsvx2x03qcxj68syi63xpfjj0-retroarch-joypad-autoconfig-1.22.0/share/libretro/autoconfig"
# keyboard_gamepad_enable = "true"
# keyboard_gamepad_mapping_type = "1"
# kiosk_mode_enable = "false"
# kiosk_mode_password = ""
# led_driver = "null"
# libretro_directory = "/nix/store/rp1kz9sihj4wxkqh263i2c5j9zm2w4v1-retroarch-with-cores-1.21.0/lib/retroarch/cores"
# libretro_info_path = "/nix/store/n000li2rd4nydah153jrfff7gvkx8xva-libretro-core-info-1.22.0/share/retroarch/cores"
...
# menu_ignore_missing_assets = "false"
...
# notification_show_autoconfig_fails = "true"
